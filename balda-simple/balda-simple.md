...
permalink-source: https://github.com/Harrix/harrix.dev-games/blob/main/balda-simple/balda-simple.md
permalink: https://harrix.dev/ru/games/balda-simple/
lang: ru
---
...
_Рисунок 2 — Первый игрок составляет слово «РОТА» и получает 4 очка_

![Второй игрок составляет слово «РОГ» и получает 3 очка](img/play_02.svg)

_Рисунок 3 — Второй игрок составляет слово «РОГ» и получает 3 очка_

![Первый игрок составляет слово «ГАД» и получает 3 очка](img/play_03.svg)

_Рисунок 4 — Первый игрок составляет слово «ГАД» и получает 3 очка_
